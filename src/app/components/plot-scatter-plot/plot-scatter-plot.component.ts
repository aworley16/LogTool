...
@Component({
  selector: 'app-plot-scatter-plot',
  templateUrl: './plot-scatter-plot.component.html',
  styleUrls: ['./plot-scatter-plot.component.scss']
})
export class PlotScatterPlotComponent implements OnInit {
  graph: any;
  dataInput = [];
  timeSeries  = [];
  yValue = [];
